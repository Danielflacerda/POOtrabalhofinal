...
public class TelaConsultaTurma extends javax.swing.JInternalFrame {
   ...
   String local2 = System.getProperty("user.dir") + barra + "Relatorio_Turma"+barra;
    
    File pasta = new File(local);
    File [] registros = pasta.listFiles();
    
     String [] colunas = {"Codigo Turmas","Cod. dos Professores","Disciplinas"};
    ...
    public void DadosTabela_turma(){
        ...
        try{
            ...
            String linhas [] = { registros[i].getName().replace(".txt",""),
                 mostrar.getProperty("Professor"),
                 mostrar.getProperty("Disciplina")
    ...
    public void Registro(){
        ...
        if(criar_arquivo.exists()){
            JOptionPane.showMessageDialog(rootPane, "Já existe um Relatório com esse Nome(a) \n"
                ...
                try{
                    criar_local.mkdirs();
                    //Formatter criar = new Formatter(local2+arquivo);
                    
                    for(int i = 0; i < JTturma.getRowCount(); i++){
                        ...
                        try{
                            ...
                            mostrar.load(fis);
                                    ...
                                    "\r\n Codigo da Turma: "+JTturma.getValueAt(i, 0)+"\n"+
                                    "\r\n Codigo do Professor: "+JTturma.getValueAt(i, 1)+"\n\r"+
                                    "\r\n Disciplina: "+JTturma.getValueAt(i, 2)+"\n\r");
                                    bw.newLine();
                                    bw.close();
                                    fw.close();
    ...
    ((DefaultTableModel) JTturma.getModel()).removeRow(JTturma.getSelectedRow());
    }
    ...
    private void JTturmaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JTturmaMouseClicked
        int indice_linha = JTturma.getSelectedRow();
        tfFiltro.setText(String.valueOf(JTturma.getValueAt(indice_linha, 0)));     
