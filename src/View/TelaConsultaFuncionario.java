...
public class TelaConsultaFuncionario extends javax.swing.JInternalFrame {
    ...
    String local2 = System.getProperty("user.dir") + barra + "Relatorio_Funcionario"+barra;
    
    File pasta = new File(local);
    File [] registros = pasta.listFiles();
    
     String [] colunas = {"Codigo","Nome","Cargo","Salario"};
        ...
        if(criar_arquivo.exists()){
            JOptionPane.showMessageDialog(rootPane, "Já existe um Relatório com esse Nome(a) \n"
                ...
                try{
                    ...
                    for(int i = 0; i < JTFuncionario.getRowCount(); i++){
                        ...
                        try{
                            ...
                            mostrar.load(fis);
                                    ...
                                    "\r\n Codigo: "+JTFuncionario.getValueAt(i, 0)+"\n"+
                                    "\r\n Nome: "+JTFuncionario.getValueAt(i, 1)+"\n\r"+
                                    "\r\n Cargo: "+JTFuncionario.getValueAt(i, 2)+"\n\r"+
                                    "\r\n Salario: "+JTFuncionario.getValueAt(i, 3)+"\n\r");
                                    bw.newLine();
                                    bw.close();
                                    fw.close();
    ...
    ((DefaultTableModel) JTFuncionario.getModel()).removeRow(JTFuncionario.getSelectedRow());
    }
    ...
    private void JTFuncionarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JTFuncionarioMouseClicked
       int indice_linha = JTFuncionario.getSelectedRow();
        tfFiltro.setText(String.valueOf(JTFuncionario.getValueAt(indice_linha, 0)));
